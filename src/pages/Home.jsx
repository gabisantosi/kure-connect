  ...
  return (
    <div>
      ...
      <div className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-primary bg-opacity-70 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <Link to="/contato">
              <Button className="bg-white text-primary hover:bg-primary-light hover:text-white font-bold py-3 px-6 rounded-full text-lg transition-all duration-200 transform hover:scale-105">
      ...
      <div className="container mx-auto px-4 py-20">
        <h2 className="text-4xl font-semibold mb-10 text-primary text-center">Nossos Serviços de Consultoria</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="bg-accent p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
